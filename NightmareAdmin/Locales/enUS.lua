...
--[[General]]
  --[[Tooltips]]
    ["ma_IconHint"] = "|cffeda55fClick|r to open NightmareAdmin. |cffeda55fShift-Click|r to reload the user interface.",
    ["tt_Default"] = "Move your cursor over an element to toggle the tooltip!",
    ["tt_LanguageButton"] = "Change the language and reload NightmareAdmin.",
  --[[Control Labels]]
...
--[[GM tab]]
  --[[Name]]
    ["tabmenu_Main"] = "GM",
  --[[Tooltips]]
    ["tt_MainButton"] = "Toggle NightmareAdmins Mainframe.",
...
--[[Log Tab]]
    ["tabmenu_Log"] = "Log",
    ["tt_LogButton"] = "Show the log of all actions done with NightmareAdmin.",
  --[[Tooltips]]
  --[[Control Labels]]
  --[[Other]]
