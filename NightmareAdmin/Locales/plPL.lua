...
function Return_plPL() 
  return {
    ...
    ["tt_LogButton"] = "Nacisnij przycisk, aby zobaczyc historie operacji wykonanych przez NightmareAdmin.",
    ["tt_LanguageButton"] = "Click this button to change the language and reload NightmareAdmin.",
