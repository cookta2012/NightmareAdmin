...
--[[General]]
  --[[Tooltips]]
    ["ma_IconHint"] = "|cffeda55fKlick|r um NightmareAdmin zu öffnen. |cffeda55fShift-Klick|r um das Interface neu zuladen.",
    ["tt_Default"] = "Bewege deinen Mauszeiger über ein Tab für eine Erklärung!",
    ["tt_LanguageButton"] = "Ändert die Sprache und lädt NightmareAdmin neu.",
  --[[Control Labels]]
...
--[[Log Tab]]
    ["tabmenu_Log"] = "Log",
    ["tt_LogButton"] = "Zeigt den Log von allen Aktionen die von NightmareAdmin gemacht wurden.",
  --[[Tooltips]]
  --[[Control Labels]]
  --[[Other]]
