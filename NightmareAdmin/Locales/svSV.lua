...
--[[General]]
  --[[Tooltips]]
    ["ma_IconHint"] = "|cffeda55fKlicka|r för att öppna NightmareAdmin. |cffeda55fShift-klicka|r för att ladda om ditt interface.",
    ["tt_Default"] = "Dra musen över ett element för att visa tooltipen!",
    ["tt_LanguageButton"] = "Ändra språk och ladda om NightmareAdmin.",
  --[[Control Labels]]
...
--[[GM tab]]
  --[[Name]]
     ["tabmenu_Main"] = "GM",
 --[[Tooltips]]
    ["tt_MainButton"] = "NightmareAdmins Huvudsida.",
...
--[[Log Tab]]
    ["tabmenu_Log"] = "Log",
    ["tt_LogButton"] = "Visa loggen för alla händelser gjorda med NightmareAdmin.",
  --[[Tooltips]]
  --[[Control Labels]]
  --[[Other]]
