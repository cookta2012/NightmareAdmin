...
function OBJGo()
    ...
    NightmareAdmin:ChatMsg(".go object "..obj)
    NightmareAdmin:LogAction("Go Object for player "..player..".")
end

function OBJAdd()
    local player = UnitName("target") or UnitName("player")
    local obj =	ma_Obj_idbutton:GetText()
    NightmareAdmin:ChatMsg(".gobject add "..obj)
    NightmareAdmin:LogAction("Object Add for player "..player..".")
end

function OBJMove()
    local player = UnitName("target") or UnitName("player")
    local obj =	ma_Obj_guidbutton:GetText()
    NightmareAdmin:ChatMsg(".gobject move "..obj)
    NightmareAdmin:LogAction("Object Move for player "..player..".")
end

function OBJTurn()
    local player = UnitName("target") or UnitName("player")
    local obj =	ma_Obj_guidbutton:GetText()
    NightmareAdmin:ChatMsg(".gobject turn "..obj)
    NightmareAdmin:LogAction("Object Turn for player "..player..".")
end

function OBJDel()
    local player = UnitName("target") or UnitName("player")
    local obj =	ma_Obj_guidbutton:GetText()
    NightmareAdmin:ChatMsg(".gobject delete "..obj)
    NightmareAdmin:LogAction("Object Delete for player "..player..".")
end

function OBJNear()
    local player = UnitName("target") or UnitName("player")
    NightmareAdmin:ChatMsg(".gobject near")
    NightmareAdmin:LogAction("Object Near for player "..player..".")
end
...
function OBJTarget()
	if gettingGOBinfo == 0 and gettingGOBinfoinfo == 0 then
        ...
        NightmareAdmin:ChatMsg(".gobject target")
        NightmareAdmin:LogAction("Object Target for player "..player..".")
        --gettingGOBinfoinfo=1
        NightmareAdmin:ChatMsg(".gobject info")
        --ShowGobModel()
    end
end
...
function OBJActivate()
    local player = UnitName("target") or UnitName("player")
    NightmareAdmin:ChatMsg(".gobject activate "..ma_Obj_guidbutton:GetText())
    NightmareAdmin:LogAction("Object "..ma_Obj_guidbutton:GetText().." activated for player "..player..".")
end

function OBJAddTemp()
    local player = UnitName("target") or UnitName("player")
    local obj =	ma_Obj_idbutton:GetText()
    NightmareAdmin:ChatMsg(".gobject add temp "..obj)
    NightmareAdmin:LogAction("Object Add(Temp) for player "..player..".")
end

function OBJInfo()
    local player = UnitName("target") or UnitName("player")
    NightmareAdmin:ChatMsg(".gobject info")
    NightmareAdmin:LogAction("Object "..ma_Obj_guidbutton:GetText().." info obtained for player "..player..".")
end
...
function OBJSetPhase()
    ...
    NightmareAdmin:ChatMsg(".gobject set phase "..obj.." "..phase)
    NightmareAdmin:LogAction("Object "..obj.." phase set to "..phase.." for player "..player..".")
end
...
function InitGobModelFrame()
  ma_gobjectmodel:SetScript("OnUpdate", function() NightmareAdminModelOnUpdate(arg1) end)
