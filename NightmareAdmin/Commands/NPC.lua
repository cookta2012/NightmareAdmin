...
function InitModelFrameNPC()
  ma_npcmodelframe:SetScript("OnUpdate", function() NightmareAdminNpcModelOnUpdate(arg1) end)
...
function NightmareAdminNpcModelOnUpdate(elapsedTime)
...
function Respawn()
  ...
  NightmareAdmin:LogAction("Respawned creatures near you.")
end
...
function NPCInfo()
    local player = UnitName("target") or UnitName("player")
    NightmareAdmin:ChatMsg(".npc info")
    NightmareAdmin:LogAction("Got NPC info for player "..player..".")
end
...
function NPCMove()
    local player = UnitName("target") or UnitName("player")
    NightmareAdmin:ChatMsg(".npc move")
    NightmareAdmin:LogAction("Set NPC move for player "..player..".")
end
...
function NPCDel()
    local player = UnitName("target") or UnitName("player")
    NightmareAdmin:ChatMsg(".npc del")
    NightmareAdmin:LogAction("Set NPC deleted for player "..player..".")
end

function NPC_GUID_Get()
	NightmareAdmin:ID_Setting_Start_Write(1)
    local player = UnitName("target") or UnitName("player")
    NightmareAdmin:ChatMsg(".npc info")
    NightmareAdmin:LogAction("Got NPC_GUID_Get for player "..player..".")
end

function NPC_Add()                            
    local player = UnitName("target") or UnitName("player")
    local npc = ma_NPC_idbutton:GetText()
    NightmareAdmin:ChatMsg(".npc add "..npc)
    NightmareAdmin:LogAction("NPC Spawn mob "..npc..".")
end

function NPCGo()
    local player = UnitName("target") or UnitName("player")
    local npc =	ma_NPC_guidbutton:GetText()
    NightmareAdmin:ChatMsg(".go creature "..npc)
    NightmareAdmin:LogAction("Go NPC for player "..player..".")
end

function NPCMorph()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  NightmareAdmin:ChatMsg(".modify morph "..npccname)
  NightmareAdmin:LogAction(".modify morph "..npccname..".")
end

function NPCSay()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  NightmareAdmin:ChatMsg(".npc say "..npccname)
  NightmareAdmin:LogAction(".npc say "..npccname..".")
end

function NPCYell()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  NightmareAdmin:ChatMsg(".npc yell "..npccname)
  NightmareAdmin:LogAction(".npc yell "..npccname..".")
end

function NPCAura()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  NightmareAdmin:ChatMsg(".aura "..npccname)
  NightmareAdmin:LogAction(".aura "..npccname..".")
end

function NPCUnaura()
  local cname = ma_charactertarget:GetText()
  local npccname = ma_npccharactertarget:GetText()
  NightmareAdmin:ChatMsg(".unaura "..npccname)
  NightmareAdmin:LogAction(".unaura "..npccname..".")
end

function NpcEmote(emote)
    NightmareAdmin:ChatMsg(".npc playemote "..emote)
    NightmareAdmin:LogAction("Played emote ("..emote..").")
end

function NPCBindSight()
    local npccname = ma_npccharactertarget:GetText()
    NightmareAdmin:ChatMsg(".bindsight")
    NightmareAdmin:LogAction("Sight bound to "..npccname)
end

function NPCUnBindSight()
    local npccname = ma_npccharactertarget:GetText()
    NightmareAdmin:ChatMsg(".unbindsight")
    NightmareAdmin:LogAction("Sight unbound to "..npccname)
end

function NPCComeToMe()
    local npccname = ma_npccharactertarget:GetText()
    NightmareAdmin:ChatMsg(".cometome 1")
    NightmareAdmin:LogAction("Forced "..npccname.." using ComeToMe")
...
function DisplayUP()
    ...
    NightmareAdmin:ChatMsg(".npc set model "..currentid)
end
